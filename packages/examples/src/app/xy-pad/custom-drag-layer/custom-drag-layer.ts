...
import { BoxDragPreview } from '../box-drag-preview/box-drag-preview';
...
@Component({
  ...
  `,
  styleUrl: './custom-drag-layer.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [Crosshairs, BoxDragPreview, AsyncPipe],
})
export class CustomDragLayer implements AfterViewInit, OnDestroy {
  ...
  dragLayer = this.dnd.dragLayer<SpotModel>();
  ...
  getXY(spot: SpotModel, initialOffset: Offset, currentOffset: Offset, emit = false): Offset {
